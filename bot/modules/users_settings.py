...
desp_dict = {
    ...
    "lremname": [
        "<b><i>Leech Filename Remname is combination of Regex(s) used for removing or manipulating Filename of the Leech Files</i></b>",
        '<b>Send Leech Filename Remname. Documentation Here (For Rename Using Regex)</b> : <a href="https://t.me/CANON_BOTS/4">Click Me</a> \n\n<b>Documentation Here (For Auto Rename Using Tags) :</b> <a href="https://t.me/CANON_BOTS/3">Click Me</a> \n<b>Timeout:</b> 60 sec',
    ],
    "lcaption": [
...
bot.add_handler(
    MessageHandler(
        ...
        filters=command(["t", "thumb"]) & CustomFilters.authorized,
    )
)
